...
class WalletService {
  Future<Wallet> getWalletDetails() async {
    try {
      print('🔵 WalletService: Fetching wallet details');
      
      final response = await SupabaseConfig.client.rpc('get_vendor_wallet');
      
      print('🟢 WalletService: Wallet data received: $response');
      ...
      print('🔴 WalletService: Error fetching wallet: $e');
      print('🔴 WalletService: Stack trace: $stackTrace');
  ...
  Future<Map<String, dynamic>?> getBankDetails() async {
    try {
      print('🔵 WalletService: Fetching bank details');
      
      final response = await SupabaseConfig.client.rpc('get_vendor_bank_details');
      
      print('🟢 WalletService: Bank details received: $response');
      
      return response as Map<String, dynamic>?;
    } catch (e, stackTrace) {
      print('🔴 WalletService: Error fetching bank details: $e');
      print('🔴 WalletService: Stack trace: $stackTrace');
      return null;
    }
  }
  ...
  Future<String> createWithdrawalRequest({
    ...
    try {
      print('🔵 WalletService: Creating withdrawal request for ₹$amount');
      ...
      print('🟢 WalletService: Withdrawal request created: $response');
      ...
      print('🔴 WalletService: Error creating withdrawal request: $e');
      print('🔴 WalletService: Stack trace: $stackTrace');
