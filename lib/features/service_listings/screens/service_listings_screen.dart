...
import 'service_listing_bookings_screen.dart';
...
class _ServiceListingsScreenState extends ConsumerState<ServiceListingsScreen> {
  ...
  Widget _buildListingCard(ServiceListing listing) {
    return GestureDetector(
      onTap: () => _navigateToBookingsScreen(listing),
      child: Container(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        listing.title?.isNotEmpty == true ? listing.title! : 'Untitled',
                      ...
                      Container(
                        ...
                        child: Text(
                          listing.category?.isNotEmpty == true ? listing.category! : 'Uncategorized',
                          style: const TextStyle(
                            fontSize: 12,
                  ...
                  return Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          envString.isNotEmpty ? envString.toUpperCase() : 'ENV',
                          style: const TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w500,
                            color: AppTheme.accentBlue,
  ...
  void _navigateToBookingsScreen(ServiceListing listing) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ServiceListingBookingsScreen(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.w600,
            color:
                listing.isActive ? AppTheme.successColor : AppTheme.errorColor,
          ),
        ),
        const SizedBox(height: 4),
        // Toggle Switch
        Transform.scale(
          ...
          child: Switch(
            ...
            trackColor: WidgetStatePropertyAll(Colors.green.withValues(alpha: 0.3)),
  ...
  Future<void> _toggleListingStatus(
      ServiceListing listing, bool newStatus) async {
    try {
