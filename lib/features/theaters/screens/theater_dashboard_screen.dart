...
class _TheaterDashboardScreenState
  ...
  Widget build(BuildContext context) {
    ...
    vendorAsync.whenData((vendor) {
      if (vendor != null && !_isInitialized) {
        ...
        _isInitialized = true;
        print('🟢 Initialized online status controller with: $vendorOnlineStatus');
      }
    });
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    hasTheatersAsync.when(
                      data: (hasTheaters) => _buildAdditionalActionCards(hasTheaters),
                      loading: () => _buildAdditionalActionCards(false),
                      error: (error, stack) => _buildAdditionalActionCards(false),
                    ),
  ...
  ds.DashboardStats _convertBookingStatsToGridStats(Map<String, dynamic> bookingStats) {
  ...
  Future<void> _toggleOnlineStatus(
    ...
    print('🔄 Toggling online status from ${_onlineStatusController.value} to $newStatus');
                          ...
                          ValueListenableBuilder<bool>(
                            ...
                            builder: (context, isOnline, child) {
                              return Icon(
                                Icons.circle,
                                size: 8,
                                color: isOnline ? Theme.of(context).colorScheme.onPrimary : Colors.red,
                              );
                            },
                          ),
                          const SizedBox(width: 4),
                          ValueListenableBuilder<bool>(
                            ...
                            builder: (context, isOnline, child) {
                              return AdvancedSwitch(
                                key: ValueKey(isOnline), // Force rebuild on value change
