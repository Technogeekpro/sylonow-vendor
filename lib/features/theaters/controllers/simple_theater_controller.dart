...
class SimpleTheaterController extends ChangeNotifier {
  ...
  Future<void> submitTheater() async {
    try {
      ...
      if (vendorAsync.hasValue && vendorAsync.value?.location != null) {
        ...
        print('🔍 DEBUG: Using vendor location for simple theater: $vendorLocation');
      }
      ...
      print('🔍 DEBUG: Simple theater location - Address: $address, City: $city, State: $state, PinCode: $pinCode');
      ...
      print('🔴 Error submitting theater: $e');
      rethrow;
    } finally {
      _isLoading = false;
      notifyListeners();
  ...
  Future<void> pickTheaterImages() async {
    try {
      ...
      print('🔴 Error picking theater images: $e');
      rethrow;
    }
  }
