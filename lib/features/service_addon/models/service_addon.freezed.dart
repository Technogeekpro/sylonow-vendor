...
class _$ServiceAddonImpl extends _ServiceAddon {
  ...
  @override
  String toString() {
    return 'ServiceAddon(id: $id, vendorId: $vendorId, name: $name, originalPrice: $originalPrice, discountPrice: $discountPrice, description: $description, images: $images, type: $type, unit: $unit, quantity: $quantity, stock: $stock, isAvailable: $isAvailable, sortOrder: $sortOrder, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
