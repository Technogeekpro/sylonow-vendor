...
class CreateServiceAddonScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreateServiceAddonScreen> createState() => _CreateServiceAddonScreenState();
}

class _CreateServiceAddonScreenState extends ConsumerState<CreateServiceAddonScreen> {
  ...
  final List<String> _unitOptions = ['piece', 'hour', 'day', 'kg', 'liter', 'meter'];
            ...
            children: [
              IconButton(
                ...
                style: IconButton.styleFrom(
                  backgroundColor: _stock > 0 ? AppTheme.primaryColor.withValues(alpha: 0.1) : Colors.grey.shade200,
                  foregroundColor: _stock > 0 ? AppTheme.primaryColor : Colors.grey,
                ),
              ),
              Text(
                '$_stock',
